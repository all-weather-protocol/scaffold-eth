  ...
  describe("Portfolio LP Contract Test", function () {
    ...
    describe("RadiantArbitrumVault Test", function () {
      ...
      it("Should be able to withdraw radiant deposit", async function () {
        ...
        await (await portfolioContract.connect(wallet).withdraw(amount, { gasLimit: gasLimit})).wait();
        expect(await daiContract.balanceOf(wallet.address)).to.equal(originalBalance);
